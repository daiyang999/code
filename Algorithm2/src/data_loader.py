...
def load_data(args):
    ...
    n_entity, n_relation, kg, adj_entity, adj_relation, kg1 = load_kg(args)
    #print('data loaded.')
    # print('n_user:',n_user)
    # print('n_item:',n_item)
    ...
    return n_user, n_item, n_entity, n_relation, train_data, eval_data, test_data, kg, adj_entity, adj_relation, kg1
...
def load_kg(args):
    ...
    return n_entity, n_relation, kg, adj_entity, adj_relation, kg1
