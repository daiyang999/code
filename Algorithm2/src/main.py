...
parser.add_argument('--dim', type=int, default=2048, help='dimension of user and entity embeddings')
parser.add_argument('--L', type=int, default=8, help='number of low layers')
...
parser.add_argument('--dim', type=int, default=1024, help='dimension of user and entity embeddings')
...
#         args.lr_kge=2e-4
#         args.kge_interval=3
#     for args.batch_size in [4]:
#         for args.L in [1,2,3,4,5]:
#             for args.H in [1,2,3]:
#                 for args.dim in [512,1024]:
#                     print('dataset: %s    dim: %.1f  L: %.1f    H: %.1f    batch_size: %.1f     kge_interval: %.1f'
#                   % (args.dataset, args.dim, args.L, args.H, args.batch_size,args.kge_interval))
#                     train(args, data, show_loss, show_topk)
