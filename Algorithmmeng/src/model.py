...
class MKR(object):
    ...
    def _build_low_layers(self, args):
        ...
        for i in range(args.L):
            ...
            self.user_e,self.ui,self.tail_e,self.lap_list,self.adj_r_list,self.A = user_tail([self.user_embeddings,self.item_embeddings])
            ...
            # self.user_embeddings2, self.user_embeddings3 = cc_unit([self.user_embeddings2, self.user_embeddings1])
            # self.user_embeddings=tf.nn.embedding_lookup(self.user_embeddings3, self.user_indices)
        ...
        # self.item_embeddings+=self.item_embeddings3
