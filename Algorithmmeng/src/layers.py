...
####crossu
        ...
        #     e_output1 = tf.reshape(tf.matmul(c_matrix, self.weight_ve) + tf.matmul(c_matrix_transpose, self.weight_ee),[-1, self.input_dim]) + self.bias_e


        #     # ua_e=v_output1
        #     ua_e=e_output1+v_output1
        # else:
        #     ua_e=ua_embeddings
...
####crosse
        ...
        #     ea_e+=e_output+v_output
        # else:
        #     ea_e=ea_embeddings

        return ua_e,user_embeddings, ea_e, lap_list,self.adj_r_list,self.A
