...
sylar::ConfigVar<std::list<int> >::ptr g_int_list_value_config=sylar::Config::Lookup("system.int_list",std::list<int>{3,4},"system int list");
sylar::ConfigVar<std::set<int> >::ptr g_int_set_value_config=sylar::Config::Lookup("system.int_set",std::set<int>{5,6},"system int set");
sylar::ConfigVar<std::unordered_set<int> >::ptr g_int_uset_value_config=sylar::Config::Lookup("system.int_uset",std::unordered_set<int>{7,8},"system int uset");
...
sylar::ConfigVar<std::unordered_map<std::string,int> >::ptr g_str_int_umap_value_config=sylar::Config::Lookup("system.str_int_umap",std::unordered_map<std::string,int>{{"k",3}},"system str int umap");
...
void test_yaml(){
    YAML::Node root=YAML::LoadFile("/home/daiyang/sylarhttp/bin/conf/test.yml");
    print_yaml(root,0);
...
#define XX_PM(g_var,prefix) \
    ...
    YAML::Node root=YAML::LoadFile("/home/daiyang/sylarhttp/bin/conf/log.yml");
    sylar::Config::LoadFromYaml(root);
